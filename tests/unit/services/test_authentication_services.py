...
from recipe.blueprints.authentication.services import AuthenticationException
from recipe.blueprints.authentication import services as auth_services
...
def test_can_add_user(in_memory_repo):
    ...
    # Verify that the stored hash validates the original password
...
# py -m pytest -v tests/unit/test_services.py